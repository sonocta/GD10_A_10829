...
import com.octa.gd10_a_10829.databinding.ActivityFormAddMahasiswaBinding
...
class FormAddMahasiswaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.tvTgl.setOnClickListener {
            val datePicker = DatePickerDialog.OnDateSetListener{
                    view,year,month,dayofMonth-> binding.tglView.text = dateToSring(year,month,dayofMonth)
            }
    ...
    private fun dateToSring(year: Int, month: Int, dayofMonth:Int):String{
